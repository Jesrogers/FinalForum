...
Forum.create(channel_id: 2, title: "Development", locked: false, description: 'Suspendisse interdum sapien eu lorem consectetur aliquet. Nunc sagittis ligula vestibulum, aliquam mi ac, sodales risus', position: 1)
Forum.create(channel_id: 3, title: "Company News", locked: true, description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vehicula', position: 1)
...
ForumThread.create(forum_id: 7, author_id: 1, locked: false, pinned: true, title: "Welcome!", body: "<p>Thanks for stopping by! Feel free to browse and post at your leisure.&nbsp;</p><p>Please abide by our content policy of &quot;using common sense&quot;. Send me a message if you need anything or have any feature requests.</p>", created_at: "2020-06-17 09:4.:21.662059000 +0000", updated_at: "2020-06-17 09:4.:21.662059000 +0000")
